...
public class League {
    ...
    public Team[] createTeams() {
        ...
        Player player1 = new Player("Ismail Cisse");
       // player1.setPlayerName("George Eliot");
        Player player2 = new Player("Ibrahim Cisse");
       // player2.setPlayerName();
        Player player3 = new Player("Hamza Cisse");
        //player3.setPlayerName();
         Player player4 = new Player("Kara Cisse");
